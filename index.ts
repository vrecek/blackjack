...
const draw_card = document.querySelector('.draw-card') as HTMLElement
const hold_card = document.querySelector('.hold-card') as HTMLElement
const restart = document.querySelector('.restart') as HTMLElement

const win_cont = document.querySelector('h4') as HTMLElement
